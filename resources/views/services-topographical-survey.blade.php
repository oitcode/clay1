...
<div class="continer-fluid o-top-page-banner">
  <div class="o-overlay text-white">
    ...
    Home/Services/Topographical survey
    </div>
  </div>
</div>
    ...
    <div class="row">
      ...
      <div class="col-md-6">
        ...
        <p class="text-secondary h5 mb-3">
          We also work on recording the coordinates and elevation
          (height) data of natural and artificial features within
          a designated survey area. 
        </p>
